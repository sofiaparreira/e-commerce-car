              ...
              <div class="mt-12">
                ...
                <div class="flex flex-wrap justify-end gap-4 mt-12">
                  <button
                    ...
                    type="button"
                    class="px-16 py-3 text-sm font-semibold tracking-wide bg-red-600 text-white rounded-md hover:bg-red-700"
                  >
                    Confirmar Pagamento
                  </button>
                </div>
        ...
        <div className="py-8">
          ...
          <div className="mt-4 flex flex-col items-center justify-center py-64">
            <p className="text-center text-gray-600 flex gap-2  ">
              Obrigado, <p className="first-letter:uppercase">{fullName}</p>
            </p>
