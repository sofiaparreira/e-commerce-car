        ...
        <div className="w-full max-w-6xl px-4 md:px-5 lg:px-6 mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between lg:px-6 pb-6 border-b border-gray-200 max-lg:max-w-lg max-lg:mx-auto">
            ...
            <div className="flex items-center justify-between gap-5 ">
              <button className="rounded-full py-2.5 px-3 bg-red-50 text-red-600 font-semibold text-xs text-center whitespace-nowrap transition-all duration-500 hover:bg-red-100">
                Promo Code?
              </button>
          ...
          <div className="max-lg:max-w-lg max-lg:mx-auto">
            ...
            <button className="rounded-full py-4 px-6 bg-red-600 text-white font-semibold text-lg w-full text-center transition-all duration-500 hover:bg-red-700">
              Checkout
            </button>
          </div>
        </div>
