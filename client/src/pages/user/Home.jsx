        ...
        <form class="flex items-center w-full mt-16 mb-8 x-auto">
          ...
          <div class="relative w-full">
            ...
            <input
              ...
              required=""
              placeholder="Search..."
              class="bg-gray-50 outline-none border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-300 focus:border-red-300 block w-full ps-10 p-2.5"
              id="voice-search"
              type="text"
            />
            <button
