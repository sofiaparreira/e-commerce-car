...
>>>>>>> c075e66031da3821ed7b2bf9dc88f3db21a47fa2
  ...
  // Handle right-click to edit product (admin)
  ...
  const handleDelete = async (e) => {
    ...
    try {
      ...
      // Optionally, you can navigate away or update the UI after deletion
      alert("Product deleted successfully!");
      // You can trigger a page refresh or use a parent component to remove the product from the list
  ...
  return (
    <div className="border boder-gray-200 text-white rounded-xl pb-4">
